...
| 인기 메뉴 | [`PopularMenuController.java`](src/main/java/com/example/coffee/domain/ranking/controller/PopularMenuController.java) | [`PopularMenuService.java`](src/main/java/com/example/coffee/domain/ranking/service/PopularMenuService.java) | [`OrderRepository.java`](src/main/java/com/example/coffee/domain/order/repository/OrderRepository.java), [`PopularMenuProjection.java`](src/main/java/com/example/coffee/domain/ranking/repository/PopularMenuProjection.java) | [`PopularMenuIntegrationTest.java`](src/test/java/com/example/coffee/domain/ranking/PopularMenuIntegrationTest.java), [`docs/strategy.md`](docs/strategy.md) |
